...
return [
    ...
    '檔案名稱' => 'File name',
    '附檔標題' => 'File title',
    '若有上傳圖片，將以縮圖列表方式顯示於前台文章下方' => 'If there is an upload picture, it will be displayed below the front desk.',
    '若有上傳附檔，將以列表方式顯示於前台文章下方' => 'If there is an uploaded file, it will be displayed below the front desk.',
    '下載' => 'Download',
    ...
    '按著Ctrl點選，可複選多個項目' => 'Press Ctrl and click to select multiple items',
