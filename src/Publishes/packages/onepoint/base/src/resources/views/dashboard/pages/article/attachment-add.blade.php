 ...
 * 文章
 * 1.0.01
 * packages/onepoint/base/src/resources/views/dashboard/pages/article/attachment-add.blade.php
 */
--}}
...
@section('main_block')
    @component('dashboard::components.backend-update-card', $component_datas)
        ...
        @endslot
        <div class="form-body">
            @include('dashboard::backend-update-input', ['form_array' => $form_array_normal, 'form_value' => ''])
        </div>
    @endcomponent
@endsection
