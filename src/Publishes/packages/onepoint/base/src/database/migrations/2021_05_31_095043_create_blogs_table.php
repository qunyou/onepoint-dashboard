...
class CreateBlogsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('blogs', function (Blueprint $table) {
            ...
            $table->string('blog_title')->charset('utf8')->comment('文章標題');
            $table->string('blog_title_slug')->charset('utf8')->comment('文章標題slug');
            $table->text('summary')->nullable()->charset('utf8')->comment('簡短說明');
            $table->longText('blog_content')->nullable()->charset('utf8')->comment('文章內容');
        });
    }
