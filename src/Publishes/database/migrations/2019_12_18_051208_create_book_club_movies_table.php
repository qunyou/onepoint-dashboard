...
class CreateBookClubMoviesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('book_club_movies', function (Blueprint $table) {
            ...
            $table->text('movie_title')->nullable()->charset('utf8')->comment('影片標題');
            $table->text('movie_url')->nullable()->charset('utf8')->comment('影片網址');
        });
    }
    ...
    {
        Schema::dropIfExists('book_club_movies');
    }
}
