...
class CreateBookClubPhotosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('book_club_photos', function (Blueprint $table) {
            ...
            $table->text('photo_title')->nullable()->charset('utf8')->comment('圖片標題');
            $table->text('file_name')->nullable()->charset('utf8')->comment('圖片檔名');
        });
    }
    ...
    {
        Schema::dropIfExists('book_club_photos');
    }
}
