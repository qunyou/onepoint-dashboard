...
@section('page-header')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" aria-current="page">
                <a href="{{ url(config('dashboard.uri') . '/page/index') }}">
                    @lang('page.單頁')
                </a>
            </li>
            <li class="breadcrumb-item" aria-current="page">
    ...
    @component('dashboard::components.backend-update-card', $component_datas)
        ...
        <div class="tab-content pt-3" id="myTabContent">
            <div class="tab-pane fade show active" id="normal" role="tabpanel" aria-labelledby="normal-tab">
                @include('dashboard::backend-update-input', ['form_array' => $form_array_normal, 'form_value' => $page ?? ''])
            </div>
            <div class="tab-pane fade" id="advanced" role="tabpanel" aria-labelledby="advanced-tab">
                @include('dashboard::backend-update-input', ['form_array' => $form_array_advanced, 'form_value' => $page ?? ''])
            </div>
            <div class="tab-pane fade" id="seo" role="tabpanel" aria-labelledby="seo-tab">
                @include('dashboard::backend-update-input', ['form_array' => $form_array_seo, 'form_value' => $page ?? ''])
            </div>
        </div>
    @endcomponent
@endsection
