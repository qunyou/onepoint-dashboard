...
@section('page-header')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" aria-current="page">
                <a href="{{ url(config('dashboard.uri') . '/news-category/index') }}">
                    @lang('news.新聞分類')
                </a>
            </li>
    ...
    @component('dashboard::components.backend-list-card', $component_datas)
        @if ($list)
            @component('dashboard::components.backend-list-table', [
                ...
                'with' => [
                    [
                        'with_count_string' => 'news_count',
                        'with_name' => __('news.新聞'),
                        'url' => config('dashboard.uri') . '/news/index?news_category_id=',
                        'icon' => 'fas fa-list'
                    ],
                ],
                'uri' => $uri,
                'id_string' => 'news_category_id',
